...
const moviesSchema = yup.object().shape({
    ...
    poster: yup.string().required('El póster es requerido'),
...
const MoviesForm = ({ id, handleCloseModal, movie, handleUpdateMovie, addNewMovie }) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="needs-validation" noValidate>
            <div className="row g-3">
                ...
                <div className="col-md-6">
                    <label className="form-label">Póster</label>
                    <Controller
                        control={control}
                        name="poster"
                        render={({ field }) => (
                ...
                <div className="col-12">
                    <button type="submit" className="btn btn-primary">
                        {id ? 'Actualizar película' : 'Agregar película'}
                    </button>
                </div>
            </div>
        </form>
